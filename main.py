...
from global_variables import (
    ...
    online_bg, online_sprites, offline_bg, offline_sprites, audio_path, play_audio, gravestones
)
...
def main():
    ...
    arthur = Arthur((700, 30)) # Sopra la platform

    arena.spawn(arthur)

    
    
    arena.spawn(Platform((610, FLOOR_H - 62), (527, 20))) # Platform fluttuante
